...
public class Menu extends JDialog {
  ...
  public Menu(Window owner) {
    ...
    headFont = new Font("winrateFont", Font.PLAIN, 14);
...
//        KeyStroke.getKeyStroke(VK_R, CTRL_MASK | ALT_MASK)); // 设置加速器为“Ctrl+Alt+R”
  ...
  //      KeyStroke.getKeyStroke(VK_E, CTRL_MASK | ALT_MASK)); // 设置加速器为“Ctrl+Alt+E”
   ...
   try {
	   iconblack.setImage(ImageIO.read(AnalysisFrame.class.getResourceAsStream("/assets/smallblack.png")));
   } catch (IOException e) {
   ...
   try {
	   iconwhite.setImage(ImageIO.read(AnalysisFrame.class.getResourceAsStream("/assets/smallwhite.png")));
   } catch (IOException e) {
      //TODO Auto-generated catch block
     e.printStackTrace();
   }
